...
const ListPostFaqsComponent = ({ faqsEndUser, loading }: { faqsEndUser: IFaqs[]; loading: boolean }) => {
  return (
        ...
        <div className="pb-12 md:pb-20">
          <div data-aos="fade-down" data-aos-delay="450">
            <div className="-mb-2">
              ...
              {faqsEndUser &&
                faqsEndUser.map((item: IFaqs, index) => (
                      ...
                      <div className="pl-6">
                        <div className="relative">
                          <CollapseComponent title={item.faqs_question} onEdit={null} faqsStatus={true}>
                            <div className="text-gray-400 bg-gray-800 render—html p-6">{renderHTML(item.faqs_answer)}</div>
                          </CollapseComponent>
                        </div>
                      </div>
                    </div>
...
export default ListPostFaqsComponent
