...
const StepSetting = ({ sectionHeaderData }: { sectionHeaderData: ISectionProps }) => {
          ...
          {content &&
            content.map((item, index) => (
              <tr className="text-gray-700" key={item.home_detail_nanoid}>
                ...
                <td className="border-b-2 p-4 dark:border-dark-5 text-center w-64">{item.home_detail_title}</td>
  ...
  return (
    <div className="relative">
      ...
      <CollapseComponent title="Steps section" onEdit={null}>
        <Preview />
      </CollapseComponent>
    </div>
  )
