...
import { createContentSection, deleteContentSection, getContentSectionById, updateContentSection, updateSection } from '../../../utils/APIs'
...
import { headerSchema, featureSchema } from '../../../forms'
import Image from 'next/image'
import renderHTML from 'react-render-html'
import ModalConfirmComponent from '../../atoms/ModalConfirmComponent'

const ProductSetting = ({ sectionHeaderData }: { sectionHeaderData: ISectionProps }) => {
            ...
            content.map((item, index) => (
              <tr className="text-gray-700" key={item.home_detail_nanoid}>
                ...
                <td className="border-b-2 p-4 dark:border-dark-5 text-center w-64">
                  ...
                  {item?.home_detail_media?.media_url && <Image
                ...
                <td className="border-b-2 p-4 dark:border-dark-5">
                  {item.home_detail_content[0] && renderHTML(item.home_detail_content[0])}
                </td>
  ...
  return (
    <div className="relative">
      ...
      <CollapseComponent title="Products section" onEdit={null}>
        <Preview />
      </CollapseComponent>
    </div>
  )
