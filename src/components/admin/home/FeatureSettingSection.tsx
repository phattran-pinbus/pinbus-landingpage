...
const FeatureSettingSection = ({ sectionHeaderData }: { sectionHeaderData: ISectionProps }) => {
  ...
  return (
    <div className="relative">
      ...
      <CollapseComponent title="Features section" onEdit={null}>
        <Preview />
      </CollapseComponent>
    </div>
  )
...
export default FeatureSettingSection
