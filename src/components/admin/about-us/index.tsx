...
const AboutUsSettingComponent = () => {
  ...
  const onCreate = async (formData: any) => {
    try {
      const {
        ...
        ...formData, 
        article_section: 'about-us',
        article_description: undefined,
        created_at: undefined})
      const newContent = [...posts, message].sort( (a,b) => new Date(a.article_created_at).getTime() - new Date(b.article_created_at).getTime())
      setPosts(newContent)
      setOpenEditItem('')
  ...
  const onSubmit = async (formData: any) => {
    try {
      ...
      const newContent = [...posts.filter((i) => i.article_nanoid !== formData.article_nanoid), ...message].sort(
  ...
  const handleDelete = async () => {
    try {
      ...
      const newContent = posts.filter((i) => i.article_nanoid !== isDeleting)
  ...
  return (
    <>
      <ModalFormComponent
        ...
        initialValue={!!openEditItem && openEditItem != 'create' ? posts.find((i) => i.article_nanoid === openEditItem) : {}}
      ...
      <HeaderEditor sectionName="about-us" />
      <div className="relative bg-white p-6">
        <div className="items-center flex justify-between">
          <div className="text-xl font-inter">About Us Posts</div>
          <div>
...
export default AboutUsSettingComponent
