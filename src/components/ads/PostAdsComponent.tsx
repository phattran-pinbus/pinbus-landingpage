...
const PostAdsComponent = ({ ads, content }: { ads: IArticle[]; content: any }) => {
  return (
    <section className="bg-dark-400 pt-2">
      <SectionTitle
                  ...
                  ads.map((item: IArticle) => (
                    ...
                    >
                      <article className="flex flex-col h-full">
                        ...
                        <p className="text-gray-400 font-inter font-normal flex-grow text-center">
...
export default PostAdsComponent
