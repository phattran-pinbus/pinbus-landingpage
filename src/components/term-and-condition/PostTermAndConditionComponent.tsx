...
const PostTermAndConditionComponent = ({ termAndCondition }: { termAndCondition: IPolicy }) => {
  return (
              ...
              <div className="mb-8">
                <div className="flex flex-col h-full">
                  <div className="font-normal font-inter text-gray-400 render—html">
                    {termAndCondition.policy_content && renderHTML(termAndCondition.policy_content)}
                  </div>
                </div>
              </div>
            </div>
...
export default PostTermAndConditionComponent
